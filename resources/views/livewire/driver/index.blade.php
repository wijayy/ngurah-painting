<div>
    ...
    <div class="rounded p-4 overflow-x-auto  bg-white dark:bg-neutral-700">
        ...
        <div class="grid grid-cols-14 py-2 mt-4 gap-4 min-w-3xl font-semibold items-center">
            <div class="w-10 text-center">ID_DRIVER</div>
            <div class="flex col-span-2 gap-1 items-center">
                MEMBERSHIP_NO
            </div>
            <div class="col-span-3 ">NAMA</div>
            <div class="col-span-2 text-center">STATUS_KEANGGOTAAN</div>
            <div class="col-span-2 text-center">SALDO_KOMISI</div>
            <div class="col-span-2 text-center">VERIFIED_AT</div>
        ...
        @foreach ($drivers as $key => $item)
            <div class="grid grid-cols-14 py-2 gap-4 min-w-3xl items-center">
                ...
                <div class="col-span-2 text-center"> {{ number_format($item->driver->komisi->whereNull('pembayaran')->sum('komisi'), 0, ',', '.') }}</div>
